            ...
            <table class="w-full text-sm text-left">
                ...
                >
                    <tr>
                        ...
                        <th class="px-6 py-4 text-center hidden md:table-cell"
                            >W</th
                        >
                        <th class="px-6 py-4 text-center hidden md:table-cell"
                            >D</th
                        ...
                        <th class="px-6 py-4 text-center hidden md:table-cell"
                            >L</th
                        >
                        <th class="px-6 py-4 text-center hidden sm:table-cell"
                            >GD</th
                        >
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                    {#if data.teams.length === 0}
                        <tr>
                            ...
                            >
                                No teams found. Use the admin dashboard to add
                                teams.
                            </td>
                        </tr>
                    {:else}
